...
class TimelinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post timelines_url, params: { timeline: { company_name: @timeline.company_name, description: @timeline.description, year: @timeline.year } }
    end
  ...
  test "should update timeline" do
    patch timeline_url(@timeline), params: { timeline: { company_name: @timeline.company_name, description: @timeline.description, year: @timeline.year } }
